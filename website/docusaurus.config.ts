    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          { from: '/docs/guides', to: '/docs/guides/debugging' },
          { from: '/docs/guides/covenants', to: '/docs/design/covenants' },
          { from: '/docs/guides/cashtokens', to: '/docs/design/cashtokens' },
          { from: '/docs/guides/optimization', to: '/docs/design/optimization' },
          { from: '/docs/guides/concurrency', to: '/docs/design/concurrency' },
          { from: '/docs/design', to: '/docs/design/covenants' },
