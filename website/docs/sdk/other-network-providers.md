...
The `vmTarget` option defaults to the current VM target used by CashScript, currently `BCH_2026_05`, but this can be changed to test your contract against different BCH virtual machine targets.
