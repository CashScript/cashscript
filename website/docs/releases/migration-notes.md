...
- The SDK now returns P2sh32 addresses by default. The address type can be changed to the old `p2sh20` in the options object when initilizing a contract. The configurion of the network provider is placed under this options object too.
