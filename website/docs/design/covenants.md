...
Keeping local state in NFTs and issuing NFTs as receipts are two strategies which can be used to create much more sophisticated decentralized applications. You can read more about how these building blocks combine into multi-contract systems in [Modular Contract Design](/docs/design/modular).
