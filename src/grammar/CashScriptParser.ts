...
export class CashScriptParser extends Parser {
	...
	public static readonly Bytes = 34;
	public static readonly BooleanLiteral = 35;
	public static readonly NumberUnit = 36;
	public static readonly NumberLiteral = 37;
	public static readonly StringLiteral = 38;
	public static readonly HexLiteral = 39;
	public static readonly TxVar = 40;
	...
	public functionDefinition(): FunctionDefinitionContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while (((((_la - 10)) & ~0x1F) === 0 && ((1 << (_la - 10)) & ((1 << (CashScriptParser.T__9 - 10)) | (1 << (CashScriptParser.T__10 - 10)) | (1 << (CashScriptParser.T__12 - 10)) | (1 << (CashScriptParser.T__28 - 10)) | (1 << (CashScriptParser.T__29 - 10)) | (1 << (CashScriptParser.T__30 - 10)) | (1 << (CashScriptParser.T__31 - 10)) | (1 << (CashScriptParser.T__32 - 10)) | (1 << (CashScriptParser.Bytes - 10)) | (1 << (CashScriptParser.Identifier - 10)))) !== 0)) {
				{
				{
				this.state = 59;
				this.statement();
	...
	public parameterList(): ParameterListContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (((((_la - 29)) & ~0x1F) === 0 && ((1 << (_la - 29)) & ((1 << (CashScriptParser.T__28 - 29)) | (1 << (CashScriptParser.T__29 - 29)) | (1 << (CashScriptParser.T__30 - 29)) | (1 << (CashScriptParser.T__31 - 29)) | (1 << (CashScriptParser.T__32 - 29)) | (1 << (CashScriptParser.Bytes - 29)))) !== 0)) {
				{
				this.state = 68;
				this.parameter();
				this.state = 73;
	...
	public throwStatement(): ThrowStatementContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << CashScriptParser.T__4) | (1 << CashScriptParser.T__10) | (1 << CashScriptParser.T__16) | (1 << CashScriptParser.T__17) | (1 << CashScriptParser.T__18) | (1 << CashScriptParser.T__28) | (1 << CashScriptParser.T__29) | (1 << CashScriptParser.T__30))) !== 0) || ((((_la - 32)) & ~0x1F) === 0 && ((1 << (_la - 32)) & ((1 << (CashScriptParser.T__31 - 32)) | (1 << (CashScriptParser.T__32 - 32)) | (1 << (CashScriptParser.Bytes - 32)) | (1 << (CashScriptParser.BooleanLiteral - 32)) | (1 << (CashScriptParser.NumberLiteral - 32)) | (1 << (CashScriptParser.StringLiteral - 32)) | (1 << (CashScriptParser.HexLiteral - 32)) | (1 << (CashScriptParser.Identifier - 32)))) !== 0)) {
				{
				this.state = 114;
				this.expression(0);
				}
	...
	public functionCall(): FunctionCallContext {
		...
		try {
			...
			_la = this._input.LA(1);
			if (!(_la === CashScriptParser.T__10 || _la === CashScriptParser.Identifier)) {
	...
	public expression(_p?: number): ExpressionContext {
		...
		try {
			...
			case 4:
				...
				_la = this._input.LA(1);
				if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << CashScriptParser.T__16) | (1 << CashScriptParser.T__17) | (1 << CashScriptParser.T__18))) !== 0))) {
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 3:
						...
						_localctx._op = this._input.LT(1);
						_la = this._input.LA(1);
						if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << CashScriptParser.T__11) | (1 << CashScriptParser.T__21) | (1 << CashScriptParser.T__22) | (1 << CashScriptParser.T__23))) !== 0))) {
							_localctx._op = this._errHandler.recoverInline(this);
						} else {
							if (this._input.LA(1) === Token.EOF) {
								this.matchedEOF = true;
	...
	public static readonly _serializedATN: string =
		...
		"\x03\x03\x03\x03\x04\x03\x04\x03\x04\x03\x04\x03\x04\x07\x04?\n\x04\f" +
		"\x04\x0E\x04B\v\x04\x03\x04\x03\x04\x03\x05\x03\x05\x03\x05\x03\x05\x07" +
		...
		"\x03\x0E\x03\x0E\x05\x0E\x8C\n\x0E\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03" +
		"\x0F\x03\x10\x03\x10\x03\x10\x03\x11\x03\x11\x03\x11\x03\x11\x07\x11\x9A" +
		"\n\x11\f\x11\x0E\x11\x9D\v\x11\x05\x11\x9F\n\x11\x03\x11\x03\x11\x03\x12" +
		"\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12" +
		"\x03\x12\x05\x12\xAE\n\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03" +
		"\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03" +
		"\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03" +
		"\x12\x03\x12\x03\x12\x07\x12\xCA\n\x12\f\x12\x0E\x12\xCD\v\x12\x03\x13" +
		"\x03\x13\x03\x13\x03\x13\x05\x13\xD3\n\x13\x03\x14\x03\x14\x05\x14\xD7" +
		"\n\x14\x03\x15\x03\x15\x03\x15\x02\x02\x03\"\x16\x02\x02\x04\x02\x06\x02" +
		"\b\x02\n\x02\f\x02\x0E\x02\x10\x02\x12\x02\x14\x02\x16\x02\x18\x02\x1A" +
		"\x02\x1C\x02\x1E\x02 \x02\"\x02$\x02&\x02(\x02\x02\t\x04\x02\r\r++\x03" +
		"\x02\x13\x15\x03\x02\x16\x17\x03\x02\x14\x15\x04\x02\x0E\x0E\x18\x1A\x03" +
		"\x02\x1B\x1C\x03\x02\x1F$\x02\xE6\x02*\x03\x02\x02\x02\x04-\x03\x02\x02" +
		"\x02\x069\x03\x02\x02\x02\bE\x03\x02\x02\x02\nR\x03\x02\x02\x02\f^\x03" +
		"\x02\x02\x02\x0Ef\x03\x02\x02\x02\x10h\x03\x02\x02\x02\x12n\x03\x02\x02" +
		"\x02\x14s\x03\x02\x02\x02\x16y\x03\x02\x02\x02\x18\x81\x03\x02\x02\x02" +
		"\x1A\x84\x03\x02\x02\x02\x1C\x8D\x03\x02\x02\x02\x1E\x92\x03\x02\x02\x02" +
		" \x95\x03\x02\x02\x02\"\xAD\x03\x02\x02\x02$\xD2\x03\x02\x02\x02&\xD4" +
		"\x03\x02\x02\x02(\xD8\x03\x02\x02\x02*+\x05\x04\x03\x02+,\x07\x02\x02" +
		"\x03,\x03\x03\x02\x02\x02-.\x07\x03\x02\x02./\x07+\x02\x02/0\x05\b\x05" +
		"\x0204\x07\x04\x02\x0213\x05\x06\x04\x0221\x03\x02\x02\x0236\x03\x02\x02" +
		"\x0242\x03\x02\x02\x0245\x03\x02\x02\x0257\x03\x02\x02\x0264\x03\x02\x02" +
		"\x0278\x07\x05\x02\x028\x05\x03\x02\x02\x029:\x07\x06\x02\x02:;\x07+\x02" +
		"\x02;<\x05\b\x05\x02<@\x07\x04\x02\x02=?\x05\x0E\b\x02>=\x03\x02\x02\x02" +
		"?B\x03\x02\x02\x02@>\x03\x02\x02\x02@A\x03\x02\x02\x02AC\x03\x02\x02\x02" +
		"B@\x03\x02\x02\x02CD\x07\x05\x02\x02D\x07\x03\x02\x02\x02EN\x07\x07\x02" +
		"\x02FK\x05\n\x06\x02GH\x07\b\x02\x02HJ\x05\n\x06\x02IG\x03\x02\x02\x02" +
		...
		"PQ\x07\t\x02\x02Q\t\x03\x02\x02\x02RS\x05(\x15\x02ST\x07+\x02\x02T\v\x03" +
		"\x02\x02\x02UY\x07\x04\x02\x02VX\x05\x0E\b\x02WV\x03\x02\x02\x02X[\x03" +
		"\x02\x02\x02YW\x03\x02\x02\x02YZ\x03\x02\x02\x02Z\\\x03\x02\x02\x02[Y" +
		"\x03\x02\x02\x02\\_\x07\x05\x02\x02]_\x05\x0E\b\x02^U\x03\x02\x02\x02" +
		"^]\x03\x02\x02\x02_\r\x03\x02\x02\x02`g\x05\x10\t\x02ag\x05\x12\n\x02" +
		"bg\x05\x14\v\x02cg\x05\x16\f\x02dg\x05\x18\r\x02eg\x05\x1A\x0E\x02f`\x03" +
		"\x02\x02\x02fa\x03\x02\x02\x02fb\x03\x02\x02\x02fc\x03\x02\x02\x02fd\x03" +
		"\x02\x02\x02fe\x03\x02\x02\x02g\x0F\x03\x02\x02\x02hi\x05(\x15\x02ij\x07" +
		"+\x02\x02jk\x07\n\x02\x02kl\x05\"\x12\x02lm\x07\v\x02\x02m\x11\x03\x02" +
		"\x02\x02no\x07+\x02\x02op\x07\n\x02\x02pq\x05\"\x12\x02qr\x07\v\x02\x02" +
		"r\x13\x03\x02\x02\x02su\x07\f\x02\x02tv\x05\"\x12\x02ut\x03\x02\x02\x02" +
		"uv\x03\x02\x02\x02vw\x03\x02\x02\x02wx\x07\v\x02\x02x\x15\x03\x02\x02" +
		"\x02yz\x07\r\x02\x02z{\x07\x07\x02\x02{|\x07*\x02\x02|}\x07\x0E\x02\x02" +
		"}~\x05\"\x12\x02~\x7F\x07\t\x02\x02\x7F\x80\x07\v\x02\x02\x80\x17\x03" +
		"\x02\x02\x02\x81\x82\x05\x1E\x10\x02\x82\x83\x07\v\x02\x02\x83\x19\x03" +
		"\x02\x02\x02\x84\x85\x07\x0F\x02\x02\x85\x86\x07\x07\x02\x02\x86\x87\x05" +
		"\"\x12\x02\x87\x88\x07\t\x02\x02\x88\x8B\x05\f\x07\x02\x89\x8A\x07\x10" +
		"\x02\x02\x8A\x8C\x05\f\x07\x02\x8B\x89\x03\x02\x02\x02\x8B\x8C\x03\x02" +
		"\x02\x02\x8C\x1B\x03\x02\x02\x02\x8D\x8E\x05(\x15\x02\x8E\x8F\x07\x07" +
		"\x02\x02\x8F\x90\x05\"\x12\x02\x90\x91\x07\t\x02\x02\x91\x1D\x03\x02\x02" +
		"\x02\x92\x93\t\x02\x02\x02\x93\x94\x05 \x11\x02\x94\x1F\x03\x02\x02\x02" +
		"\x95\x9E\x07\x07\x02\x02\x96\x9B\x05\"\x12\x02\x97\x98\x07\b\x02\x02\x98" +
		"\x9A\x05\"\x12\x02\x99\x97\x03\x02\x02\x02\x9A\x9D\x03\x02\x02\x02\x9B" +
		"\x99\x03\x02\x02\x02\x9B\x9C\x03\x02\x02\x02\x9C\x9F\x03\x02\x02\x02\x9D" +
		"\x9B\x03\x02\x02\x02\x9E\x96\x03\x02\x02\x02\x9E\x9F\x03\x02\x02\x02\x9F" +
		"\xA0\x03\x02\x02\x02\xA0\xA1\x07\t\x02\x02\xA1!\x03\x02\x02\x02\xA2\xA3" +
		"\b\x12\x01\x02\xA3\xA4\x07\x07\x02\x02\xA4\xA5\x05\"\x12\x02\xA5\xA6\x07" +
		"\t\x02\x02\xA6\xAE\x03\x02\x02\x02\xA7\xAE\x05\x1C\x0F\x02\xA8\xAE\x05" +
		"\x1E\x10\x02\xA9\xAA\t\x03\x02\x02\xAA\xAE\x05\"\x12\v\xAB\xAE\x07+\x02" +
		"\x02\xAC\xAE\x05$\x13\x02\xAD\xA2\x03\x02\x02\x02\xAD\xA7\x03\x02\x02" +
		"\x02\xAD\xA8\x03\x02\x02\x02\xAD\xA9\x03\x02\x02\x02\xAD\xAB\x03\x02\x02" +
		"\x02\xAD\xAC\x03\x02\x02\x02\xAE\xCB\x03\x02\x02\x02\xAF\xB0\f\n\x02\x02" +
		"\xB0\xB1\t\x04\x02\x02\xB1\xCA\x05\"\x12\v\xB2\xB3\f\t\x02\x02\xB3\xB4" +
		"\t\x05\x02\x02\xB4\xCA\x05\"\x12\n\xB5\xB6\f\b\x02\x02\xB6\xB7\t\x06\x02" +
		"\x02\xB7\xCA\x05\"\x12\t\xB8\xB9\f\x07\x02\x02\xB9\xBA\t\x07\x02\x02\xBA" +
		"\xCA\x05\"\x12\b\xBB\xBC\f\x06\x02\x02\xBC\xBD\x07\x1D\x02\x02\xBD\xCA" +
		"\x05\"\x12\x07\xBE\xBF\f\x05\x02\x02\xBF\xC0\x07\x1E\x02\x02\xC0\xCA\x05" +
		"\"\x12\x06\xC1\xC2\f\r\x02\x02\xC2\xCA\x07\x11\x02\x02\xC3\xC4\f\f\x02" +
		"\x02\xC4\xC5\x07\x12\x02\x02\xC5\xC6\x07\x07\x02\x02\xC6\xC7\x05\"\x12" +
		"\x02\xC7\xC8\x07\t\x02\x02\xC8\xCA\x03\x02\x02\x02\xC9\xAF\x03\x02\x02" +
		"\x02\xC9\xB2\x03\x02\x02\x02\xC9\xB5\x03\x02\x02\x02\xC9\xB8\x03\x02\x02" +
		"\x02\xC9\xBB\x03\x02\x02\x02\xC9\xBE\x03\x02\x02\x02\xC9\xC1\x03\x02\x02" +
		"\x02\xC9\xC3\x03\x02\x02\x02\xCA\xCD\x03\x02\x02\x02\xCB\xC9\x03\x02\x02" +
		"\x02\xCB\xCC\x03\x02\x02\x02\xCC#\x03\x02\x02\x02\xCD\xCB\x03\x02\x02" +
		"\x02\xCE\xD3\x07%\x02\x02\xCF\xD3\x05&\x14\x02\xD0\xD3\x07(\x02\x02\xD1" +
		"\xD3\x07)\x02\x02\xD2\xCE\x03\x02\x02\x02\xD2\xCF\x03\x02\x02\x02\xD2" +
		"\xD0\x03\x02\x02\x02\xD2\xD1\x03\x02\x02\x02\xD3%\x03\x02\x02\x02\xD4" +
		"\xD6\x07\'\x02\x02\xD5\xD7\x07&\x02\x02\xD6\xD5\x03\x02\x02\x02\xD6\xD7" +
		"\x03\x02\x02\x02\xD7\'\x03\x02\x02\x02\xD8\xD9\t\b\x02\x02\xD9)\x03\x02" +
		"\x02\x02\x124@KNY^fu\x8B\x9B\x9E\xAD\xC9\xCB\xD2\xD6";
