export default {
  ...
  constructorInputs: [
    { name: 'expectedLockingBytecode', type: 'bytes' },
  ],
  abi: [
    { name: 'spend', inputs: [] },
  ],
  ...
  fingerprint: '962e0f47da985bbd13b47bb2aee039dd5244d7c8bce98a8c97bd45e46090bed6',
  debug: {
    ...
    logs: [
      ...
      },
      {
        ...
        data: [
          'inputBytecode:',
          { stackIndex: 0, type: 'bytes', ip: 10 },
        ],
      },
    ],
    requires: [
      { ip: 3, line: 3 },
      { ip: 7, line: 7, message: 'output bytecode should match' },
      { ip: 11, line: 11, message: 'input bytecode should match' },
    ],
  },
  compiler: {
    name: 'cashc',
  ...
  updatedAt: '2026-05-16T17:36:02.138Z',
} as const;
