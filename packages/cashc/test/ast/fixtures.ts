        ...
        [new FunctionDefinitionNode(
          ...
          new BlockNode([
            new VariableDefinitionNode(
              ...
              'myVariable',
              new BinaryOpNode(
                new IntLiteralNode(10n),
                BinaryOperator.MINUS,
                new IntLiteralNode(4n),
              ),
            ),
            new VariableDefinitionNode(
              PrimitiveType.INT,
