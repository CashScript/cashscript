...
export const fixtures = {
  ...
  applyBinaryOperator: {
    success: [
      ...
      // hex
      ['should apply 0xdead + 0xbeef', '0xdead', BinaryOperator.PLUS, '0xbeef', '0xdeadbeef'],
      ['should apply 0x + 0x', '0x', BinaryOperator.PLUS, '0x', '0x'],
      ['should apply almost_maxlen_x + 0x58', `0x${'58'.repeat(519)}`, BinaryOperator.PLUS, '0x58', `0x${'58'.repeat(520)}`],
      ['should apply maxlen_x + 0x', `0x${'58'.repeat(520)}`, BinaryOperator.PLUS, '0x', `0x${'58'.repeat(520)}`],
      ['should apply 0x + maxlen_x', '0x', BinaryOperator.PLUS, `0x${'58'.repeat(520)}`, `0x${'58'.repeat(520)}`],
      // MINUS
      ...
      ['should apply 0x424348 == 0x424348', '0x424348', BinaryOperator.EQ, '0x424348', true],
      ['should apply 0x424348 == 0x425443', '0x424348', BinaryOperator.EQ, '0x425443', false],
      ['should apply 0x424348 == 0x425356', '0x424348', BinaryOperator.EQ, '0x425356', false],
      // NE
      ...
      ['should apply 0x424348 != 0x424348', '0x424348', BinaryOperator.NE, '0x424348', false],
      ['should apply 0x424348 != 0x425443', '0x424348', BinaryOperator.NE, '0x425443', true],
      ['should apply 0x424348 != 0x425356', '0x424348', BinaryOperator.NE, '0x425356', true],
    ],
    fail: [
      // DIV
      ...
      ['should fail on maxlen_x + 0x58', `0x${'58'.repeat(520)}`, BinaryOperator.PLUS, '0x58', Error.ATTEMPTED_BIG_PUSH],
      ['should fail on large_x + large_y', `0x${'58'.repeat(260)}`, BinaryOperator.PLUS, `0x${'59'.repeat(261)}`, Error.ATTEMPTED_BIG_PUSH],
      // MINUS
  ...
  applyUnaryOperator: {
    success: [
      ['should apply !true', UnaryOperator.NOT, true, false],
      ['should apply !false', UnaryOperator.NOT, false, true],
      ['should apply -10', UnaryOperator.NEGATE, 10, -10],
      ['should apply -(-10)', UnaryOperator.NEGATE, -10, 10],
      ['should apply -MAXINT', UnaryOperator.NEGATE, MAXINT, -MAXINT],
      ['should apply -(-MAXINT)', UnaryOperator.NEGATE, -MAXINT, MAXINT],
      ['should apply -0', UnaryOperator.NEGATE, 0, 0],
      ['should apply -(-0)', UnaryOperator.NEGATE, -0, 0],
    ],
    fail: [
      ['should fail on -(MAXINT + 1)', UnaryOperator.NEGATE, MAXINT + 1, Error.INVALID_SCRIPT_NUMBER],
      ['should fail on -(-MAXINT - 1)', UnaryOperator.NEGATE, -MAXINT - 1, Error.INVALID_SCRIPT_NUMBER],
    ],
  },
};
