...
export const fixtures: Fixture[] = [
  ...
  },
  {
    ...
    artifact: {
      ...
      bytecode:
        'OP_3 OP_PICK OP_0 OP_NUMEQUAL OP_IF '
        + 'OP_4 OP_PICK OP_4 OP_SPLIT 65 OP_SPLIT OP_NIP OP_SIZE 34 OP_SUB OP_SPLIT '
  ...
  },
  {
    ...
    artifact: {
      ...
      bytecode:
        ...
        + 'OP_5 OP_PICK OP_4 OP_SPLIT 65 OP_SPLIT OP_NIP OP_SIZE 34 OP_SUB OP_SPLIT '
        + 'OP_8 OP_SPLIT OP_4 OP_SPLIT OP_NIP 20 OP_SPLIT OP_DROP '
        ...
        + 'OP_2DUP OP_CAT OP_HASH256 OP_6 OP_PICK OP_EQUALVERIFY OP_2DROP OP_ENDIF '
