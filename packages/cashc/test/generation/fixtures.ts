...
export const fixtures: Fixture[] = [
  ...
  },
  {
    ...
    artifact: {
      ...
      source: fs.readFileSync(new URL('../valid-contract-files/unused_modifier.cash', import.meta.url), { encoding: 'utf-8' }),
      compiler: {
        name: 'cashc',
        version,
        options: {
  ...
  },
  {
    ...
    fn: 'tuple_reassignment_branches.cash',
    artifact: {
      ...
      source: fs.readFileSync(new URL('../valid-contract-files/tuple_reassignment_branches.cash', import.meta.url), { encoding: 'utf-8' }),
      compiler: {
        name: 'cashc',
        version,
        options: {
  ...
  },
  {
    ...
    artifact: {
      ...
      source: fs.readFileSync(new URL('../valid-contract-files/tuple_reassignment.cash', import.meta.url), { encoding: 'utf-8' }),
      compiler: {
        name: 'cashc',
        version,
        options: {
  ...
  },
  {
    ...
    artifact: {
      ...
      source: fs.readFileSync(new URL('../valid-contract-files/double_negation.cash', import.meta.url), { encoding: 'utf-8' }),
      compiler: {
        name: 'cashc',
        version,
        options: {
