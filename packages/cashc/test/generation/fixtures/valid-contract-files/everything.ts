...
export const fixtures: Fixture[] = [
  {
    artifact: {
      ...
      bytecode:
        // int i = 400 + x;
        '9001 OP_OVER OP_ADD '
        // bytes b = 0x07364897987fe807 + bytes(y);
        ...
        // i = 400;
        + '9001 OP_5 OP_ROLL OP_DROP OP_SWAP OP_TOALTSTACK OP_SWAP OP_TOALTSTACK OP_ROT OP_ROT OP_FROMALTSTACK OP_FROMALTSTACK '
        // }
        + 'OP_ENDIF '
        // if (x > 10) {
