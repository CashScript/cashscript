...
export const fixtures: Fixture[] = [
  {
    artifact: {
      ...
      bytecode:
        ...
        + 'OP_TOALTSTACK OP_ROT OP_ROT OP_FROMALTSTACK OP_FROMALTSTACK OP_FROMALTSTACK OP_ENDIF '
        // require(a > b + c + d + e + f);
        + 'OP_2ROT OP_5 OP_ROLL OP_ADD OP_4 OP_ROLL OP_ADD '
        + 'OP_3 OP_ROLL OP_ADD OP_ROT OP_ADD OP_GREATERTHAN',
      debug: {
        bytecode: '5152535455565579539f6353567a757c6b7c6b7c6b7b7b6c6c6c6871557a93547a93537a937b93a0',
        logs: [],
        requires: [{ ip: 40, line: 14 }],
      ...
      fingerprint: 'e586fb63aa0c9791cdf96f5472328a702565bd0e1da1bb101dc2619c5655f465',
    },
  },
];
