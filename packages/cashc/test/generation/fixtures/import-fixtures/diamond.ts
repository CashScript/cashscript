...
const readImportFixture = (name: string): string => fs.readFileSync(
...
export const fixtures: Fixture[] = [
  {
    artifact: {
      ...
      debug: {
        ...
        sources: {
          'leaf.cash': readImportFixture('leaf.cash'),
          'mid1.cash': readImportFixture('mid1.cash'),
          'mid2.cash': readImportFixture('mid2.cash'),
        },
