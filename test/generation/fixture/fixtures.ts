...
export const irFixtures: Fixture[] = [
  {
    ...
    ir: [
      ...
      Op.OP_DROP, Op.OP_DROP, Op.OP_DROP, new PushBool(true),
    ],
    script: 'OP_1 OP_PICK OP_SHA256 OP_1 OP_PICK OP_EQUAL OP_VERIFY OP_2 OP_PICK '
          + 'OP_2 OP_PICK OP_CHECKSIG OP_VERIFY OP_DROP OP_DROP OP_DROP OP_1',
  },
  {
    ...
    ir: [
      ...
      Op.OP_DROP, Op.OP_DROP, Op.OP_DROP, Op.OP_DROP, Op.OP_DROP, Op.OP_DROP,
      Op.OP_DROP, Op.OP_DROP, new PushBool(true),
    ],
    script: 'OP_10 OP_4 OP_SUB 14 OP_1 OP_PICK OP_2 OP_MOD OP_ADD OP_0 OP_PICK OP_3 '
          ...
          + 'OP_VERIFY OP_7 OP_PICK OP_7 OP_PICK OP_CHECKSIG OP_VERIFY OP_DROP OP_DROP '
  ...
  },
  {
    ...
    script: 'OP_2 OP_PICK OP_4 OP_PICK OP_ADD OP_0 OP_PICK OP_4 OP_PICK OP_SUB OP_0 '
          ...
          + 'OP_PICK OP_NUMEQUAL OP_VERIFY OP_DROP OP_DROP OP_DROP OP_DROP OP_DROP OP_DROP OP_DROP OP_1',
  },
  {
    ...
    ir: [
      ...
      Op.OP_DROP, Op.OP_DROP, Op.OP_DROP, Op.OP_DROP, Op.OP_DROP, new PushBool(true),
    ...
    script: 'OP_3 OP_PICK OP_0 OP_NUMEQUAL OP_IF OP_4 OP_PICK OP_2 OP_PICK OP_CHECKSIG '
          + 'OP_VERIFY OP_DROP OP_DROP OP_DROP OP_DROP OP_DROP OP_1 OP_ELSE OP_3 OP_PICK '
          + 'OP_1 OP_NUMEQUAL OP_IF OP_4 OP_PICK OP_1 OP_PICK OP_CHECKSIG OP_VERIFY OP_2 '
          + 'OP_PICK OP_CHECKLOCKTIMEVERIFY OP_DROP OP_DROP OP_DROP OP_DROP OP_DROP OP_DROP '
  ...
  },
  {
    ...
    script: 'OP_2 OP_PICK OP_0 OP_NUMEQUAL OP_IF OP_3 OP_PICK OP_5 OP_PICK OP_ADD '
          ...
          + 'OP_0 OP_PICK OP_5 OP_PICK OP_NUMEQUAL OP_VERIFY OP_DROP OP_DROP OP_DROP '
          + 'OP_DROP OP_DROP OP_DROP OP_DROP OP_1 OP_ENDIF OP_ENDIF',
  },
  {
  ...
  },
  {
    ...
    script: 'OP_0 OP_PICK OP_1 OP_PICK OP_SIZE OP_NIP OP_2 OP_DIV OP_SPLIT OP_NIP OP_0 '
          ...
          + 'OP_DROP OP_1 OP_PICK OP_EQUAL OP_NOT OP_VERIFY OP_DROP OP_DROP OP_1',
  },
  {
    ...
    script: 'OP_0 OP_PICK OP_RIPEMD160 OP_0 OP_HASH160 OP_EQUAL OP_1 OP_NOT OP_EQUAL '
          + 'OP_VERIFY OP_1 OP_PICK OP_1 OP_PICK OP_CHECKSIG OP_VERIFY OP_DROP OP_DROP OP_1',
  },
  {
    ...
    script: 'OP_1 OP_PICK OP_1 OP_PICK OP_CHECKSIG OP_VERIFY OP_1 OP_PICK OP_SIZE '
          ...
          + 'OP_VERIFY OP_DROP OP_DROP OP_DROP OP_1',
  },
];
